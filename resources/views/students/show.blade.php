	...
	<div class="card-header">
		<div class="row">
			...
			<div class="col col-md-6">
			    <a href="{{ route('students.edit', $student->id) }}" class="btn btn-info btn-lg float-end">Edit</a> 
				<a href="{{ route('students.index') }}" class="btn btn-primary btn-lg float-end">Back</a>
			</div>
		</div>
	</div>
	<div class="card-body">
